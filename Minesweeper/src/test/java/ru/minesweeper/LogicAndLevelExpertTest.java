...
import ru.minesweeper.console.ConsoleBoard;
import ru.minesweeper.console.ConsoleCell;
...
public class LogicAndLevelExpertTest {
    ...
    public void testFinish() throws Exception {
        ...
        cells[1][1] = new ConsoleCell(true);
        cells[3][3] = new ConsoleCell(true);
        cells[5][5] = new ConsoleCell(true);
        cells[7][7] = new ConsoleCell(true);
        cells[9][9] = new ConsoleCell(true);
        for (int i = 0; i < expert.sumRow(); i++) {
            for (int j = 0; j < expert.sumColumn(); j++) {
    ...
    public void testCheckingAroundCell() throws Exception {
        ...
        cells[4][4] = new ConsoleCell(true);
        cells[4][5] = new ConsoleCell(true);
        cells[4][6] = new ConsoleCell(true);
        cells[5][4] = new ConsoleCell(true);
        cells[5][6] = new ConsoleCell(true);
        cells[6][4] = new ConsoleCell(true);
        cells[6][5] = new ConsoleCell(true);
        cells[6][6] = new ConsoleCell(true);
        ...
        for (int i = 0; i < standardLogic.sumRow(); i++) {
            for (int j = 0; j < standardLogic.sumColumn(); j++) {
                if (i < 3 || j < 3 || i > standardLogic.sumRow() - 4 || j > standardLogic.sumColumn() - 4)
                    cells[i][j] = new ConsoleCell(true);
            }
        }
