 ...
 *
 * 1. В нужном методе проверить уровень на null (как это релизовано в 5-7-ом методах),
 ...
 *    (Инициализация уровней происходит в этом классе)
 *
 * 2. В уровне расширяем класс, добавив интерфейс ILogic и в нужном методе заменяем логику
 */
