...
public class Runner {
    ...
    // Генерация поля
    public void generateField(Scanner sc, Logic level, ICell[][] cells) {
    ...
    public void generateEmptyCells(Logic level, ICell[][] cells) {
    ...
    public void cycleInput(Scanner sc, BaseAction action, Logic level) {
        int row = 0, column = 0;
        try {
            do {
                try {
